...
export const Contact = () => {
    return (
        <div className="bg-gray-900 rounded-2xl max-w-7xl mx-auto mt-20 flex flex-row p-20">
            <div className="w-1/2 flex flex-col justify-center items-center">
                <h1 className="text-3xl mb-5">Contatos <ContactsIcon /></h1>
                <p>Entre em contato atráves de qualquer uma dessas redes sociais que irei responder o mais rápido possivel!</p>
            </div>
            <div className="w-1/2 flex flex-col justify-center items-center">
